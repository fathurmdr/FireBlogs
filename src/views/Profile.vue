    ...
    <div class="container">
      ...
      <div class="profile-info">
        ...
        <div class="input">
          ...
          <input disabled type="text" id="email" v-model="dataForm.email" />
        </div>
...
export default {
  ...
  methods: {
    onChangeInput(e) {
      this.dataForm[e.target.name] = e.target.value;
    },
    updateProfile() {
      this.$store.dispatch("updateUserSettings", this.dataForm);
